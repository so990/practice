...
public class Payment_items {
	...
	public Payment_items(String pay_name, String pay_tax, String tax_free_name, String tax_free_limit, String tax_memo,
			String cut_unit, String attend_conn, String pay_cost, String pay_used) {
